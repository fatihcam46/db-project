--1-create tester and developer
--2-connect union these sets  >>>look set_operators.sql
create table Developers(  Id_Number Integer primary key,
                          Names varchar(30),
                          Salary Integer);

create table Testers( Id_Number Integer primary key,
                      Names varchar(30),
                      Salary Integer );
